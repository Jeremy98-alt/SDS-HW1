...
The homework pretends to run the Randomized Max-Cut Algorithm for a large number (M) of times and evaluate the average cut-size over these M simulations comparing it with the theoretical bound opt(G)/2 to follow the performance analysis.
